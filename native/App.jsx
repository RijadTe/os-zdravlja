...
// 🔥 PRIVREMENO ISKLJUČI setupNative funkciju
// const setupNative = async () => {
//   console.log('📱 Inicijalizacija native setup...');
//   // ... sav kod ...
// };
  // ============================================================
  // 🌙 TAMNA TEMA
  ...
  useEffect(() => {
    ...
    if (isNative) {
      // 🔥 DINAMIČKI IMPORT ZA STATUS BAR
  ...
  useEffect(() => {
    ...
    // 🔥 OVO SAKRIVA HTML LOGO KAD SE APLIKACIJA UČITA
    const splash = document.querySelector('body > div:first-child');
    if (splash) {
      splash.style.transition = 'opacity 0.5s ease';
      splash.style.opacity = '0';
